...
const Day = () => {
  return (
    <Paragraph>
      <h2>Intro</h2>
      <p>
        The hope and design of the promised land was that all could enjoy the blessings of God's
        gift. For some, that would be new homes, or a freshly planted vineyard. For others, it would
